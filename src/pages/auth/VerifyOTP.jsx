...
//     setLoading(true);
//     try {
//       const res = await fetch(`${apiConfig.API_BASE_URL}/api/auth/verify-phone-otp`, {
//         method: 'POST',
...
//         navigate('/signup', { state: { phoneVerified: true, email } });
//       } else {
...
//     if (!canResend) return;
//     try {
//       const res = await fetch(`${apiConfig.API_BASE_URL}/api/auth/send-phone-otp`, {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
...
//           <div className="text-center space-y-2">
//             <h1 className="text-2xl font-bold text-gray-800">OTP Verification</h1>
//             <p className="text-gray-500 text-sm">We have sent a verification code to</p>
