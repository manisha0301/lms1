                ...
                {isNotificationOpen && (
                  <div className="absolute right-0 mt-4 w-96 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                    <div className="bg-[#1e3a8a] text-white p-5 flex justify-between items-center">
                      ...
                      <button onClick={() => setIsNotificationOpen(false)} className="hover:bg-white/20 p-1 rounded">
                        <X className="w-5 h-5" />
                      </button>
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div className="p-8 space-y-5">
                  {branchHierarchy.map((branch, index) => (
                    <div 
                      key={branch.id}
                      className="flex items-center justify-between p-6 bg-gradient-to-r from-[#1e3a8a]/5 to-white rounded-2xl border border-[#1e3a8a]/10 hover:border-[#1e3a8a]/30 hover:shadow-lg transition-all group cursor-pointer"
                    >
                      <div className="flex items-center gap-6">
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-black text-[#1e3a8a]">{branch.students}</p>
                        <p className="text-sm text-gray-600">students • {branch.faculty} faculty</p>
                      </div>
